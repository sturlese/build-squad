...
- Never touch `.env` files or infrastructure. A plugin hook also enforces this mechanically.
...
- All documentation you produce is written in English, regardless of the language of the request.
