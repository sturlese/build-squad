...
7. **Report.** What moved where and why; consumers rewired to shared pieces; test evidence (baseline vs after, identical); mechanical test updates declared; defects found-but-not-fixed as `/squad:bug` candidates; docs updated.
